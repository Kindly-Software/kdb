...
impl std::fmt::Display for Vp9SegmentationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::None => write!(f, "no error"),
            Self::InvalidSegmentId => write!(f, "invalid segment ID"),
            Self::InvalidFeature => write!(f, "invalid feature index"),
            Self::BoolDecoderError => write!(f, "boolean decoder error"),
            Self::NotEnabled => write!(f, "segmentation not enabled"),
            Self::InvalidState => write!(f, "invalid state"),
            Self::DataOverflow => write!(f, "data range overflow"),
        }
    }
}

impl std::error::Error for Vp9SegmentationError {}
