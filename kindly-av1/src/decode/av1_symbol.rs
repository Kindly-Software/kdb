...
impl std::fmt::Display for Av1SymbolError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::RangeUnderflow => write!(f, "range underflow"),
            Self::InvalidCdf => write!(f, "invalid CDF"),
            Self::InvalidBitCount => write!(f, "invalid bit count"),
...
impl std::error::Error for Av1SymbolError {}
