...
impl QuantFormat {
    /// Get the scale factor for this quantization format.
    ///
    /// Returns the scale factor as 2^fractional_bits:
    /// - Q4.4: 2^4 = 16.0
    /// - Q6.6: 2^6 = 64.0
    /// - Q8.8: 2^8 = 256.0
    ///
    ...
    ///
    /// ```
    /// use kindly_compression::weight_compression::QuantFormat;
    ///
    /// assert_eq!(QuantFormat::Q4_4.scale(), 16.0);
    /// assert_eq!(QuantFormat::Q6_6.scale(), 64.0);
    /// assert_eq!(QuantFormat::Q8_8.scale(), 256.0);
    /// ```
    #[inline]
