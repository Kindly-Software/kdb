...
use super::breaker::{AtomicBreakerGuard, LayoutKind, State};
use super::cause;
use super::diag::DiagSnapshot;
#[cfg(feature = "circuit-breaker-compact48")]
use super::layout::Compact48;
use super::layout::{Layout, LayoutRaw, Standard64};

/// Aggregation input sample containing a packed breaker word and optional diagnostics.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[cfg_attr(
    feature = "circuit-breaker-serde",
