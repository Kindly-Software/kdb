...
use crate::patterns::circuit_breaker::telemetry::HistoryBuffer;
...
mod tests {
    ...
    use crate::patterns::circuit_breaker::layout::pack_q8_8;
    use crate::patterns::circuit_breaker::telemetry::history::HistoryEntry;
    use crate::patterns::circuit_breaker::telemetry::ActionOutcome;
    use crate::patterns::circuit_breaker::telemetry::TelemetrySample;

    fn make_entry(ts: u32, mu: f32, sg: f32, success: bool) -> HistoryEntry {
        let snapshot = crate::patterns::circuit_breaker::breaker::MetricsSnapshot {
