...
//!
//! # Purpose
//! Command-line interface for LLM training dataset deduplication.
//!
//! # Architecture
//! - Zero-dependency argument parsing
//! - High-performance command routing
//! - Concurrent processing with advanced fingerprinting
//! - Comprehensive audit trails for all operations
//!
//! # Performance
//! - CLI parsing: <1ms (one-time startup cost)
//! - Command dispatch: Optimized routing
