use crate::components::molecular::{FeatureCard, SectionContainer};
use leptos::prelude::*;
...
pub fn Security() -> impl IntoView {
    let certifications = vec![
        (
            "SOX",
            "Sarbanes-Oxley",
            "Hash chain audit trails for financial compliance",
        ),
        (
            "SOC2 Type II",
            "Service Organization Control",
            "Tamper-proof logging for observation period",
        ),
        (
            "GDPR",
            "General Data Protection",
            "Data access logging and right to be forgotten tracking",
        ),
        (
            "HIPAA",
            "Health Insurance Portability",
            "PHI access logging and breach detection",
        ),
    ];
