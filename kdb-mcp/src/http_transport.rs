...
use atomic_capsule::http::{
    HttpRequest, HttpResponse, StatusCode, Method, Version,
    HttpServerCapsule, HttpRouterCapsule, HeaderParserCapsule,
};
use crate::{JsonRpcCapsule, McpServerCapsule, RateLimiterCapsule};
...
impl HttpTransportCapsule {
    ...
    pub fn handle_request(
        ...
        // 6. Check rate limit (token bucket)
