            ...
            >
                <p
                    ...
                    style="color: rgba(255, 255, 255, 0.6); \
                           ...
                           margin: 0;"
                >
                    "Performance Disclaimer: All performance metrics measured on AMD Ryzen 9 6900HX (8 cores/16 threads @ 3.3GHz base, 64GB DDR5-4800). "
                    "Actual performance varies by CPU architecture, memory bandwidth, core count, and dataset characteristics. "
                    "Single-threaded validated: 60K docs/sec (38× speedup). Multi-threaded measured: 300K docs/sec (190× speedup @ 8c/16t). "
