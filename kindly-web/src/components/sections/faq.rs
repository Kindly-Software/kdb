...
pub fn FAQ() -> impl IntoView {
    let faqs = vec![
        FaqItem {
            ...
            answer: "One-time license purchase with lifetime updates. Early Adopter License: $497 (limited to first 10). Pro License: $997. Enterprise: Custom quote for on-premise deployment.",
        },
        FaqItem {
            question: "Is there a free trial?",
            answer: "Yes! Download the demo binary for a free trial with a 5M document limit. Fully functional for testing and evaluation purposes.",
        },
        FaqItem {
        ...
        FaqItem {
            question: "How do you achieve 38× single-threaded and 190× multi-threaded speedup?",
            answer: "Rust's zero-cost abstractions, lockfree parallelism, SIMD vectorization, and advanced minihash algorithms. All performance claims validated with 95% confidence intervals (1000+ iterations).",
        },
        FaqItem {
