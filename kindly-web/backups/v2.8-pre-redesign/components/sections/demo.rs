...
pub fn Demo() -> impl IntoView {
    let tiers = vec![
        ...
        (
            ...
            "1M documents",
            "~17 seconds",
            "60,000+ docs/sec single-threaded",
        ),
        (
            "Tier 3: Scale Demo",
            "10M documents",
            "~11 seconds",
            "912K docs/sec @ 16 cores (persistent mode)",
        ),
    ];
    ...
    view! {
        ...
        >
            <div style="max-width: 1200px; margin: 0 auto;">
                ...
                >
                    <p>
                        "Demo performance measured on AMD Ryzen 9 6900HX. "
                        "Tier 3 requires ≥8 GB RAM. Hardware binding prevents VM cloning and reinstallation bypass."
                    </p>
                </div>
            </div>
        </section>
