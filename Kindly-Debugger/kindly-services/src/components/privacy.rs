...
// audit trail disclosure (cryptographic hash-chain integrity)
...
pub fn PrivacyPage() -> impl IntoView {
    let effective_date = "December 4, 2025";
    let last_updated = "December 4, 2025";
    ...
    let sections = vec![
        ...
        PrivacySection {
            ...
            content: vec![
                ...
                "Payment Information: Processed entirely by Paddle. We receive only a transaction ID and subscription status. We never see, store, or have access to your credit card numbers, CVV, or banking details.",
        ...
        PrivacySection {
            ...
            icon: Some("audit"),
            content: vec![
                "The Kindly Debugger implements cryptographic hash-chain audit trails for compliance with SOX, SOC2, GDPR, and HIPAA requirements. This is a unique privacy-preserving audit system.",
                ...
                "What Is Logged: Action type, timestamp, anonymized actor identifier, success/failure status. The chain uses SHA-256 hashing with instant verification.",
                "What Is NOT Logged: Your debugging sessions, source code, or any data from your applications. trails are administrative only.",
            ...
            highlight: Some("Cryptographic tamper-evidence with instant verification"),
        },
        PrivacySection {
            id: "mcp-protocol",
        ...
        PrivacySection {
            ...
            content: vec![
                ...
                "Access Controls: Strict need-to-know access policies. All administrative access is logged via audit trails.",
                ...
                "Breach Notification: In the event of a data breach affecting your personal information, we will notify affected users and relevant supervisory authorities within 72 hours of becoming aware of the breach, as required by GDPR Article 33. Notifications will include the nature of the breach, categories of data affected, approximate number of individuals impacted, and remediation steps taken.",
            ],
        ...
        PrivacySection {
            ...
            content: vec![
                ...
                "Time-Travel Snapshots: The replay engine stores execution snapshots locally with instant capture. These never leave your machine.",
        ...
        PrivacySection {
            ...
            content: vec![
                ...
                "GDPR Article 22 Rights: You have the right not to be subject to decisions based solely on automated processing, including profiling, which produces legal effects or similarly significantly affects you. The Kindly Debugger does not engage in automated decision-making or profiling. All license decisions, support escalations, and account actions involve human review.",
            ],
        ...
        PrivacySection {
            ...
            content: vec![
                ...
                "SOC2 Type II: Our infrastructure and processes are pursuing SOC2 Type II certification for security, availability, and confidentiality.",
                "HIPAA: For healthcare customers, we offer Business Associate Agreements (BAA). audit trails support HIPAA audit requirements.",
        ...
        PrivacySection {
            ...
            content: vec![
                ...
                "Audit Logs: 7 years (regulatory compliance), immutable.",
                "Server Access Logs: 7 days, then permanently deleted.",
                "Payment Records: Managed by Paddle per their retention policy; we retain only transaction IDs for 7 years.",
        ...
        PrivacySection {
            ...
            content: vec![
                "Paddle: Payment processing only. Paddle is PCI-DSS Level 1 certified. View Paddle's privacy policy at paddle.com/legal/privacy.",
            ...
            highlight: Some("One third party (Paddle for payments) - that is all"),
        },
        PrivacySection {
            id: "children",
            ...
            icon: Some("child"),
            content: vec![
                "The Kindly Debugger is a professional software development tool not intended for use by children under 18 years of age.",
                ...
                "If you believe we have collected information from a child under 18, please contact privacy@kindly.software immediately.",
            ],
            highlight: None,
        },
        PrivacySection {
            ...
            <div style="max-width: 900px; margin: 0 auto;">
                ...
                >
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
                        ...
                        <div style="text-align: center;">
                            <div style="font-size: 2rem; margin-bottom: 0.5rem;">"Audit Compliant"</div>
                ...
                >
                    ...
                    <div style="max-width: 700px; margin: 0 auto;">
                        ...
                        <p style="color: rgba(255, 255, 255, 0.85); line-height: 1.7; margin-bottom: 2rem;">
                            "We use zero third-party trackers, sell zero data, and provide cryptographic audit trails via our system. Privacy is not a checkbox for us - it is the foundation of our architecture."
                        </p>
...
mod tests {
    ...
    fn test_section_data_integrity() {
        ...
        let sections = [
            ...
            ("q34-audit-trails", "Audit Trail System"),
