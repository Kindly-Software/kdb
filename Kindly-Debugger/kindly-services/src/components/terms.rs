            ...
            <div style="max-width: 900px; margin: 0 auto;">
                ...
                >
                    <p style="color: rgba(255, 255, 255, 0.9); line-height: 1.8; margin-bottom: 1rem;">
                        "These Terms of Service (\"Terms\") constitute a legally binding agreement between you (\"User,\" \"you,\" or \"your\") and Kindly Software Inc, a Canadian corporation (\"Kindly,\" \"we,\" \"us,\" or \"our\"), governing your access to and use of the Kindly Debugger service, including the time-travel debugging platform, MCP protocol integrations, and related software (collectively, the \"Service\")."
                    </p>
    ...
    vec![
        ...
        TermsSection {
            ...
            clauses: vec![
                TermsClause {
                    number: "5.1",
                    content: "Kindly Ownership: The Service, including all software, algorithms, user interfaces, documentation, and the proprietary time-travel debugging technology (including audit trail systems and high-performance architecture), is owned exclusively by Kindly Software Inc and protected by intellectual property laws.",
                },
                TermsClause {
                    number: "5.2",
                ...
                TermsClause {
                    number: "5.5",
                    content: "Trade Secrets: The proprietary architecture, high-performance coordination patterns, and time-travel debugging algorithms constitute trade secrets. Any attempt to reverse engineer, decompile, or extract these proprietary technologies is strictly prohibited.",
                },
            ],
        },
        ...
        TermsSection {
            ...
            clauses: vec![
                ...
                TermsClause {
                    number: "6.3",
                    content: "Audit Trail Immutability: Our Service maintains cryptographic hash-chain audit trails for compliance purposes. IMPORTANT: Due to the immutable nature of these audit trails, we cannot delete or modify audit log entries. Audit trails include: timestamps, user actions, session identifiers, and integrity hashes. Audit trails do NOT include: source code, variable values, or debug content.",
                },
                TermsClause {
                    number: "6.4",
        ...
        TermsSection {
            ...
            clauses: vec![
                ...
                TermsClause {
                    number: "7.2",
                    content: "Automatic Renewal: Subscriptions automatically renew at the end of each billing period unless cancelled at least 7 days before the renewal date. Pricing may be adjusted upon renewal with 30 days prior notice.",
                },
                TermsClause {
                    number: "7.3",
                ...
                TermsClause {
                    number: "7.4",
                    content: "Refunds: All sales are final. Monthly subscriptions: No refunds for partial months. Annual subscriptions: No refunds after subscription activation. Enterprise agreements: Refund terms as specified in your Enterprise agreement.",
                },
                TermsClause {
                    number: "7.5",
