            ...
            <div style="max-width: 1400px; margin: 0 auto;">
                ...
                <div style="text-align: center; margin-bottom: 4rem;">
                    ...
                    <p style="color: rgba(255, 255, 255, 0.6); font-size: 0.95rem; max-width: 700px; margin: 0 auto;">
                        "Effective Date: December 4, 2025 | Version 1.0 | Last Updated: December 4, 2025"
                    </p>
                </div>
...
Components:
  ...
  SIGNATURE - Ed25519 signature over payload"#}
                ...
                >
                    <div style="display: grid; gap: 1.5rem;">
                        <LicenseClause number="5.1" title="Hash-Chain Audit Trail">
                            "The Software implements cryptographic hash-chain audit trails. \
                    ...
                    <div style="display: grid; gap: 1.5rem;">
                        <LicenseClause number="6.1" title="Subscription Model">
                            "Paid licenses are offered on monthly or annual subscription terms. \
                             ...
                             and processed via Paddle secure payment infrastructure."
                        </LicenseClause>
                        ...
                        <LicenseClause number="6.3" title="Refund Policy">
                            "All sales are final. Monthly subscriptions: No refunds for partial months. \
                             Annual subscriptions: No refunds after subscription activation. \
                             Enterprise agreements: Refund terms as specified in your Enterprise agreement."
                        </LicenseClause>
                    </div>
                </LicenseSection>
                ...
                >
                    <div style="display: grid; gap: 1.5rem;">
                        <LicenseClause number="10.1" title="Governing Law and Arbitration">
                            "This Agreement shall be governed by and construed in accordance with the laws \
                             of the State of Delaware, United States, without regard to its conflict of law provisions. \
                             Any disputes not resolved informally shall be resolved by binding arbitration administered \
                             by the American Arbitration Association (AAA) under its Commercial Arbitration Rules. \
                             The arbitration shall take place in Wilmington, Delaware, unless the parties agree otherwise."
                        </LicenseClause>
                ...
                <div style="text-align: center; margin-top: 4rem; padding-top: 2rem; border-top: 1px solid rgba(255, 215, 0, 0.2);">
                    <p style="color: rgba(255, 255, 255, 0.5); font-size: 0.9rem; margin-bottom: 0.5rem;">
                        "Kindly Debugger is a trademark of Kindly Software Inc."
                    </p>
                    <p style="color: rgba(255, 255, 255, 0.4); font-size: 0.85rem;">
                        "Copyright 2025 Kindly Software Inc. All rights reserved."
                    </p>
                </div>
            </div>
        </div>
