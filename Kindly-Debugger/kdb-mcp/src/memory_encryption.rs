...
impl MemoryEncryptionCapsule {
    ...
    fn get_or_derive_key(
        ...
        // Safety: cached_ptr came from Box::into_raw below or in derive key path
        // #ASSUME_PTR_VALIDITY: ptr came from Box::into_raw, valid during cache hit check
        // #ASSUME_CLONE_SAFE: DerivedKey Clone is copy semantics (no aliasing issues)
